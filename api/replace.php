...
if ($v->passes()) {
  try {
    $sql = 'update orders set order_status_id =?,new_price=?, storage_id=0 where id=? and driver_id=? and driver_invoice_id=0 and storage_id=0 and invoice_id=0 and locker=0';
