...
$start .= " 00:00:00";
try {
  $count = "select count(*) as count, sum(new_price) as total from orders
...
print_r(json_encode(array($query, 'orders' => $ps[0]['count'], "total" => $ps[0]['total'], "success" => $success, "data" => $data, 'pages' => $pages, 'nextPage' => $page + 2)));
