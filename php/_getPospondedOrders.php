...
try{
  ...
  $query = "select orders.*,
            ...
            ";
  $where = "where";
  $filter = "driver_id =".$_SESSION['userid']." and order_status_id=7   and confirm=1 and driver_invoice_id=0";
  if(!empty($search)){
...
echo (json_encode(array($_POST,"success"=>$success,"data"=>$data,'pages'=>$pages,'nextPage'=>$page+2)));
?>