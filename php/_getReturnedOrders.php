...
try{
  ...
  $query = "select orders.*,
            ...
            ";
  $where = "where ";
  $filter = "orders.driver_id =".$_SESSION['userid']." and (order_status_id=6 or order_status_id=9)  and confirm=1 and (driver_invoice_id=0 or driver_invoice.invoice_status=0)";
  if(!empty($search)){
